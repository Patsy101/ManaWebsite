    ...
    <div>
            ...
            <div className="row">
              <div className="section-title shining-button">
                ...
                <p>
                  ...
                  get back to you as soon as possible. (Please be advised that Manna Kitchen Ormiston will never ask for your bank card information/physical address via email,phone and  live chat support)
                </p>
              </div>
      ...
      <div className="form-group">
        <a href="https://www.legislation.govt.nz/act/public/2020/0031/latest/LMS23223.html" target="_blank" rel="noopener noreferrer">
          Read the Privacy Act 2020 NZ (Please be advised that Manna Kitchen Ormiston will never ask for your bank card information/physical address via email,phone and  live chat support)
        </a>
